...
COPY --from=build /work/target/release/hhm-leptos-web /usr/local/bin/hhm-leptos-web
USER app
...
ENTRYPOINT ["/usr/local/bin/sops-entrypoint.sh", "/usr/local/bin/hhm-leptos-web"]
